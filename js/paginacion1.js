Paginador = function(divPaginador, tabla) {
    ...
    this.Mostrar = function() {
        ...
        num.className = 'numero_page btn btn-outline-danger';

       /* var count = fil.insertCell(fil.cells.length);
        count.innerHTML = self.paginas; //número total de paginas
        count.className = 'numero_page btn btn-outline-danger';
        ...
        sig.className = 'pag_btn btn btn-outline-danger';
